...
public class SqlDataReader extends DbDataReader
  ...
  public SqlDataReader(NObject handle) {
    super(handle);
  ...
  @MethodTypeAnnotation(type = "Method")
  public IDataReader GetData(java.lang.Integer i) {
    try {
      Object res =
          javonetHandle.explicitInterface("jio.System.Data.IDataRecord").invoke("GetData", i);
      if (res == null) return null;
      return ConvertToConcreteInterfaceImplementation(res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();

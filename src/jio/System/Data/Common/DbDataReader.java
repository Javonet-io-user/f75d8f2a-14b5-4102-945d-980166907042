...
public abstract class DbDataReader extends MarshalByRefObject
  ...
  public DbDataReader(NObject handle) {
    super(handle);
  ...
  @MethodTypeAnnotation(type = "Method")
  public IDataReader GetData(java.lang.Integer ordinal) {
    try {
      Object res =
          javonetHandle.explicitInterface("jio.System.Data.IDataRecord").invoke("GetData", ordinal);
      if (res == null) return null;
      return ConvertToConcreteInterfaceImplementation(res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();

...
public class GetErrorCompletedEventArgs extends AsyncCompletedEventArgs {
  ...
  public java.lang.String getreplyUserName() {
    try {
      java.lang.String res = javonetHandle.get("replyUserName");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public java.lang.String getreplyEmailAddress() {
    try {
      java.lang.String res = javonetHandle.get("replyEmailAddress");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public java.lang.String getuserMessage() {
    try {
      java.lang.String res = javonetHandle.get("userMessage");
      if (res == null) return "";
      return (java.lang.String) res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  @MethodTypeAnnotation(type = "GetField")
  public Object getscreenByteArray() {
    try {
      Object res = javonetHandle.<NObject>get("screenByteArray");
  ...
  public GetErrorCompletedEventArgs(NObject handle) {
    super(handle);

...
public class DBDateTime extends ValueType {
  ...
  public DBDateTime(DBNull aDBNull) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("BCE.Data.DBDateTime", aDBNull);
  ...
  public DBDateTime(DateTime newValue) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("BCE.Data.DBDateTime", newValue);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  ...
  public DBDateTime(NObject handle) {
    super(handle);
